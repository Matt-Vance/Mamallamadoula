...
<html>
<head>
<title>Mama Llama Doula Birth Services</title>
...
<div class = "container">
    ...
    <div class = "container-content">
        <div class = "main-content" id = "main-content">
            <div class="doula-definition" >
                <h1>What does a birth doula do?</h1>
            ...
            <div class="doula-bulletpoints">
                ...
                <ul>
                    ...
                    <li>I provide emotional support, physical comfort measures, and objective viewpoint, and assistance to the woman in getting the information she needs to make good decisions.</li>
            ...
            <div class="intro-info" >
                <div class="intro-main">
                    ...
                    <div class="intro-content">
                        ...
                        <p>In addition to being a birth doula, I am also a certified lactation educator and a degreed nutritionist. I attented college at Cal Poly SLO where I earned a B.S. in Applied Nutrition
                        it was in the class, "Maternal and Child Nutrition" that I first discovered my interest in pregnancy, birth, and breastfeeding.</p>
                        <br />
                        <br />
    ...
    <div class="consultation-main">
        <div class="consultation-content">
            ...
            <div class="consultation-button"id="services">
                <a href="mailto:name@email.com">Link text</a><button type="button" id="consultation">Contact Me</button></a>
            </div>
        </div>
    </div>
    <div class="main-content2">
        ...
        <div class="faqs">
            ...
            <div class="faq" id="faq6">
                ...
                <h4>A </h4><p>
                The doula may be the only person at the labor besides the partner who is there solely for the emotional well-being of the woman. 
                The nurse, the doctor, the midwife have other priorities that compete with the emotional care of the woman; for example, breaks, 
                shift changes, clinical responsibilities, office hours and hospital policies. The doula has few or no other priorities. She stays 
                through shift changes, and until the baby is born. She is not just another stranger with the couple. She has the woman's needs as her sole priority.
                </p>
            </div>
    ...
    <form class="email-form" method="POST" enctype="text/plain" action="MAILTO: mvance43776@gmail.com">
        <br>
